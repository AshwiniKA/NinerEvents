...
public class EventDAOImpl implements EventDAO {
	...
	@Override
	public void insertFeedback(Event event) {
		String SQL = "INSERT INTO feedback " +
				"(first_name, last_name, event_name, rating, comments) VALUES (?, ?, ?, ?,?)";
		jdbcTemplateObject = new JdbcTemplate(dataSource);


			jdbcTemplateObject.update(SQL, new Object[] { event.getFirst_name(),
				event.getLast_name(), event.getEventName(),event.getRating(), event.getComments()
			});
